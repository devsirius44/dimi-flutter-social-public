...
class NewMembersItemSmall extends StatelessWidget {
  
  final NewMember member;

  const NewMembersItemSmall({Key key, this.member}) : super(key: key);
        ...
        children: <Widget>[
          Container(height: 90, width: 100, child: Stack(children: <Widget>[
            ...
            Padding(
              ...
              child: StatusMark(member.online ? 'Online' : 'Offline', backgroundColor: member.online ? Color(0xaa1db33b) : (0x66000000),),
              //child: StatusMarkLarge(widget.member.online ? 'Online' : 'Offline', backgroundColor: widget.member.online ? Color(0xff1db33b) : Color(0x66000000),)
            )
          ])),
